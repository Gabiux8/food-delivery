...
const RestaurantDetails = () => {
  ...
  useEffect(() => {
    dispatch(
      getMenuItemsByRestaurantId({
        ...
        none_vegetarian: foodType === "None-Vegetarian",
  ...
  return (
    <div className="px-5 lg:px-20">
      <section>
        <h3 className="text-black py-2 mt-10">Home/Europe/Portuguese food/3</h3>
        <div>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <img className={restaurant.restaurant?.images[0]} alt="" />
            </Grid>
